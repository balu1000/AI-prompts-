...
gcr.io/k8s-k3s/demo:v1.0.0;ports;initialDelaySeconds;
timeoutSeconds;failureThreshold;periodSeconds"      | Manifest demonstrating a liveness probe.   | [Example](./yaml/app-livenessProbe.yaml)                   |
